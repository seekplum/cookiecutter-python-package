...
def test(
    ...
    inv test --source {{cookiecutter.project_slug}}/fib.py --tests tests/test_fib.py
...
def coverage(
    ...
    inv coverage --source {{cookiecutter.project_slug}}/fib.py --tests tests/test_fib.py
    """
...
def pylint(
    ...
    inv pylint --source '{{cookiecutter.project_slug}} *.py' --msg-ids="W1505" --packages="paramiko,pyyaml"
    """
